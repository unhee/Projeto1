...
{
  Serial.begin(9600);
  //Pino, calibracao - Cur Const= Ratio/BurdenR. 1800/62 = 29. Calibração do sensor
...
void loop()
{
  ...
  if (tempoInicio == 0) {
    ...
    tempoPercorrido = (millis() - tempoInicio) / 1000; //tranforma em s

  }
  else {
    tempoPercorrido = (tempoFim - tempoInicio) / 1000; //transforma em s
  }
